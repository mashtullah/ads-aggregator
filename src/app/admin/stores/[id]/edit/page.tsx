...
export default function AdminEditStore() {
  ...
  if (!store) return <div className="animate-pulse p-8">Loading Store Data...</div>;
      ...
      <div className="glass-panel" style={{ padding: '2rem' }}>
        <form onSubmit={handleUpdate}>
           ...
           <div className="mb-8">
              ...
              <p className="mb-4" style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>Force reset the owner's password below.</p>
